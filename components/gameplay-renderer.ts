...
export function drawGameplayFrame(
  ...
  context.save();
  if (normalized.startsWith("trackmania")) drawNightDrive(context, elapsed, width, height);
  else if (normalized.startsWith("temple")) drawMarbleFlow(context, elapsed, width, height);
